...
import { HyperliquidMonitor } from './hyperliquidMonitor.js';
...
export class CopyTradingService {
    ...
    async startMonitoring(config) {
        ...
        monitor.onNewTrade(async (trade) => {
    ...
    async storeTrade(walletAddress, trade, result) {
        try {
            console.log('💾 Storing trade in database:', {
                walletAddress,
                symbol: trade.symbol,
...
//# sourceMappingURL=copyTradingService.js.map